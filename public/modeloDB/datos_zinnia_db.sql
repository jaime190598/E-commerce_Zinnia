...
insert into product values(0,null, null,'05SDFG124','Camisa corte V',110.99,4,'camisa de corte en v, manga larga, con estampados','camisa_v.png',1,1,2,2,3),
						  (0,null, null,'05SDFG123','Top corte V',120.99,4,'Top de corte en v, manga larga, con estampados','top.png',1,1,3,3,1),
                          (0,null, null,'05SDFG121','Pantalon vestir',310.99,4,'Pantalon, tea lisa, con lineas','pantalon.png',1,2,2,1,3),
						  (0,null, null,'05SDFG122','Jeans vaquero',220.99,4,'Jeans tela gruesa corte vaquero','jeans_v.png',1,2,3,5,2),
						  (0,null, null,'05SDFG124','Reloj Diamont',1120.99,4,'Metalico, corte diamante, cristal, bateria solar','reloj.png',1,6,1,9,4),
						  (0,null, null,'05SDFG124','Pulso canon',900.99,4,'De oro de 15 kilates, trenzado','pulso.png',1,6,1,9,1);
